...
// ----------------------------------------------------------------
/**
 * Abstract class representing a base use case for executing business logic with Kotlin Flow.
 ...
 */
abstract class FlowUseCase<PARAM, RESULT> : UseCase<PARAM, Flow<RESULT>>()